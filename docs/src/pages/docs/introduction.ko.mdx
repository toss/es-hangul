...
es-hangul은 한글 과학에 기반한 문자 처리에 집중하며, 초성, 중성, 종성 추출 및 변환과 같은 도메인 지식이 필요한 작업을 수행합니다. 일반적인 문자열 처리는 표준 라이브러리를 통해 처리할 수 있도록 하여, 라이브러리의 유지보수 비용을 절감하고 사용자에게 유연성을 제공합니다.
