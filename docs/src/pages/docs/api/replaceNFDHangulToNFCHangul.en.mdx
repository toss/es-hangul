...
Converts NFD Hangul to NFC Hangul. If the string contains old Hangul characters that are not used in modern Hangul and cannot be converted, it throws an `IrreplaceableOldHangulError`.
