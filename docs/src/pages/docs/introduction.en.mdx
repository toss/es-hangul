...
Our library provides a [modern API](./api/getChoseong) that can be conveniently used in various applications.

#### First Consonant Search ([getChoseong](./api/getChoseong))
