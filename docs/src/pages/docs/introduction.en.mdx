...
es-hangul focuses on processing Hangul Unicode characters, performing tasks that require domain-specific knowledge such as extracting and converting initial, medial, and final consonants. General string processing is delegated to standard libraries, reducing maintenance costs and providing flexibility to users.
