...
// 12항 [붙임 2] 규정에 따라 'ㄷ'으로 발음되는 받침이 뒤 음절 첫소리 'ㅎ'과 결합되면 [ㅌ]으로 발음한다. (예: 숱하다[수타다], 옷 한 벌[오탄벌])
// 'ㅈ'도 'ㄷ'으로 발음되지만, 받침 'ㅈ'은 [붙임 1](발음변환_첫소리_ㅎ)에서 이미 [ㅊ]으로 처리하므로(예: 맞히다[마치다]) 여기에서는 제외한다.
export const 발음변환_첫소리_ㅎ_ㄷ대표음 = ['ㅅ', 'ㅆ', 'ㅊ', 'ㅌ'] as const;
